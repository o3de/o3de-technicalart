...
namespace HoudiniEngine
{
    ...
    public:
        ...
        void AddMeshStreamBuffer(AZ::RPI::ModelLodAssetCreator& modelLodCreator, const HoudiniMeshData& meshData) const;
    ...
    void AttributeBuffer<AttributeTypeT>::AddMeshStreamBuffer(
        AZ::RPI::ModelLodAssetCreator& modelLodCreator, const HoudiniMeshData& meshData) const
    {
