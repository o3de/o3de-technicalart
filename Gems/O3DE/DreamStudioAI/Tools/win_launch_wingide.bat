...
CALL %PATH_DCCSI_TOOLS%\Dev\Windows\Env_O3DE_Core.bat

:: add to the PATH here (this is global)
SET PATH=%PATH_O3DE_BIN%;%PATH_O3DE_TECHART_GEMS%;%PATH_DCCSIG%;%PATH%

:: Initialize env
CALL %PATH_DCCSI_TOOLS%\Dev\Windows\Env_O3DE_Python.bat
...
:: Initialize env
CALL %PATH_DCCSI_TOOLS%\Dev\Windows\Env_DCC_Maya.bat
SET PATH=%DCCSI_PY_MAYA%;%PATH%

CALL %PATH_DCCSI_TOOLS%\Dev\Windows\Env_DCC_Blender.bat
SET PATH=%DCCSI_BLENDER_PY_EXE%;%PATH%

CALL %PATH_DCCSI_TOOLS%\Dev\Windows\Env_DCC_Substance.bat
SET PATH=%DCCSI_SUBSTANCE_PY_EXE%;%PATH%

CALL %PATH_DCCSI_TOOLS%\Dev\Windows\Env_IDE_Wing.bat
...
SET "O3DE_DREAMSTUDIO_GEM=%BASEDIR%\o3de_dreamstudio"
echo     O3DE_DREAMSTUDIO_GEM = %O3DE_DREAMSTUDIO_GEM%
