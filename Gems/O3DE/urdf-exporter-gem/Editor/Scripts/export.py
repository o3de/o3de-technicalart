...
def search_tree(root, xml_obj, urdf_mesh_path, robot_name):
    """
...
def add_elements(entity_id, xml_obj, urdf_mesh_path, robot_name):
    """
...
def look_up_component_type(component_type_name, root, component_type_id, urdf_mesh_path, xml_obj, robot_name):
    """
